...
--
-- Table structure for table `check_hash`
--

DROP TABLE IF EXISTS `check_hash`;
...
--
-- Dumping data for table `check_hash`
--

LOCK TABLES `check_hash` WRITE;
/*!40000 ALTER TABLE `check_hash` DISABLE KEYS */;
/*!40000 ALTER TABLE `check_hash` ENABLE KEYS */;
UNLOCK TABLES;
